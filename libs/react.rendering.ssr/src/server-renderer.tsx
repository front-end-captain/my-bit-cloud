...
import { Html, MountPoint } from "@unknown/ui-foundation.ui.rendering.html";
import type { HtmlProps, Assets } from "@unknown/ui-foundation.ui.rendering.html";
...
export class ServerRenderer {
  ...
  constructor(
    ...
    private plugins: ServerRenderPlugin[],
  ...
  async render(children: ReactNode, session: SsrSession): Promise<string> {
    ...
    const renderedHtml = `<!DOCTYPE html>${renderToStaticMarkup(html)}`;
